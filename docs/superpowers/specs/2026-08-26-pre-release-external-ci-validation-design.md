...
| --- | --- | --- | --- | --- |
| Small Python | `redrose2100/openruyi-precommit-hooks#28` | `1a0e915e4e0daa89cce0b97dc488801fe4225a0e` | `pre-commit run --all-files --show-diff-on-failure` | Deterministic, mutation-producing lint failure and fresh-snapshot containment |
