#[cfg(test)]
mod hierarchy_contract {
    use super::reprocut_core::ReductionUnit;
    use super::reprocut_workspace::{DirectoryHierarchy, HierarchyGroupKind};

    #[test]
    fn directories_are_emitted_before_leaves() {
